...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "ilos.ai" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "ilos.ai — AI Operating Systems for Modern Businesses",
    description: "We design and deploy AI systems that run your operations — so you don't have to.",
    images: ["/og-image.png"],
  },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" className={`${geistSans.variable} h-full`}>
      <body className="min-h-full flex flex-col antialiased bg-neutral-950 text-white">
        {children}
      </body>
    </html>
  );
